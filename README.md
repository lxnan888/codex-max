...
Codex Mini 开源的主要目的，是让有服务器或开发能力的朋友可以自行部署、改造和二次开发，也欢迎有能力的朋友一起探索 Windows 版本等更多形态。

如果你不想折腾部署，或者没有自己的服务器，可以直接下载我构建好的 DMG 应用使用。DMG 构建版会持续维护，并优先提供最新功能；部分新功能可能不会第一时间同步到开源版，开源版会保持可用和维护，但节奏可能略滞后。
